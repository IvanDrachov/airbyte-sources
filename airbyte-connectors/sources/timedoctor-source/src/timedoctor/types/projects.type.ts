// To parse this data:
//
//   import { Convert, Projects } from "./file";
//
//   const projects = Convert.toProjects(json);
//
...
export class Convert {
    public static toProjects(json: string): Project {
        return cast(JSON.parse(json), r("Projects"));
    }

    public static projectsToJson(value: Project): string {
        return JSON.stringify(uncast(value, r("Projects")), null, 2);
    }
}
